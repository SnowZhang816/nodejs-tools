...
export class Sprite extends BaseRender {
	texture = null;
	constructor(texture) {
		super();
	...
	updateVertices() {
		let width = this.texture.getWidth();
		let halfWidth = width / 2;
		let height = this.texture.getHeight();
	...
	render(render, gl, screenMatrix) {
		...
		let textureUniformLocation = gl.getUniformLocation(shaderProgram, 'u_texture0');
