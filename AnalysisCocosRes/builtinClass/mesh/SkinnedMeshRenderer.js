class SkinnedMeshRenderer {
	...
	extendRefToId(objs, t) {
		...
		this.extendRefToIdWithKey(objs, t, "_skeleton");
		this.extendRefToIdWithKey(objs, t, "_rootBone");
...
let skinnedMeshRenderer = new SkinnedMeshRenderer();
module.exports = skinnedMeshRenderer;